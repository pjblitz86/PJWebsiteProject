...
namespace PJWebsiteProject.Models.DrinkModels.MockData
{
	...
	{
		private readonly IDrinkCategoryRepository _categoryRepository = new MockDrinkCategoryRepository();
			...
			get
			{
				return new List<Drink>
				{
					new Drink {
						...
						DrinkCategory = _categoryRepository.DrinkCategories.First(),
					...
					new Drink
					{
						...
						DrinkCategory = _categoryRepository.DrinkCategories.Last(),
		...
		public IEnumerable<Drink> PreferedDrinks { get; }
